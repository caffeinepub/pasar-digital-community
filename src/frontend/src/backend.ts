...
import type { ExternalBlob as _ExternalBlob, Time as _Time, UserRole as _UserRole, Vehicle as _Vehicle, VehicleStatus as _VehicleStatus, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async registerVehicle(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string, arg6: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.registerVehicle(arg0, arg1, arg2, arg3, arg4, arg5, await to_candid_ExternalBlob_n21(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_VehicleStatus_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VehicleStatus): VehicleStatus {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        status: from_candid_VehicleStatus_n17(_uploadFile, _downloadFile, value.status),
        model: value.model,
        transferCode: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.transferCode)),
        vehiclePhoto: await from_candid_ExternalBlob_n20(_uploadFile, _downloadFile, value.vehiclePhoto),
        owner: value.owner,
        year: value.year,
